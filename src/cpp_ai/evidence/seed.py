...
def build_seed_ledger() -> EvidenceLedger:
    ...
    e: list[EvidenceEntry] = [
        ...
        EvidenceEntry(
            ...
            cargo_type="protein",
            uptake_metric="most effective protein carrier vs R9, transportan, TAT, penetratin",
            outcome="success",
            mechanism="unknown",
            citation=KANG_2017,
            confidence="high",
            notes="Delivered proteins 6–150 kDa non-covalently; also worked in Chlorella and Nannochloropsis.",
        ),
        EvidenceEntry(
        ...
        EvidenceEntry(
            ...
            cargo_type="protein",
            outcome="partial",
            uptake_metric="less effective protein carrier than pVEC",
            mechanism="unknown",
            citation=KANG_2017,
            confidence="high",
            notes="The context reversal: strong in mammalian cells, weaker than pVEC for algae protein delivery.",
        ),
        EvidenceEntry(
            peptide_name="Transportan",
            sequence=SEQ["Transportan"],
